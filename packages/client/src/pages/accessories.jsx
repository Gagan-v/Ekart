  ...
  useEffect(() => {
    const fetchAccessoryProducts = async () => {
      try {
        ...
        // Filter products where category is "accessories"
        // This follows the same pattern as mobile.jsx and laptops.jsx
        const accessoryProducts = response.data.filter(
          (product) => product.category === "accessories"
        );
        setProducts(accessoryProducts);
      } catch (err) {
        setError("Failed to fetch accessory products");
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="max-w-6xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Accessories</h1>
          <p className="text-gray-600">
            Discover essential accessories to complement your devices
          </p>
        </div>
        ...
        {products.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">
              Check back later for new accessory arrivals!
            </p>
          </div>
        ) : (
